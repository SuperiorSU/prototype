    ...
    <div>
        <div  className="md:ms-[50px] group h-[320px]">
            <div className="w-[280px] slid relative h-[320px] mx-auto flex justify-center items-center border overflow-hidden border-[#32184b]">
              <div className="w-[280px] slide absolute h-[320px] translate-x-[-270px] group-hover:translate-x-[-10px] transition-all ease-in-out duration-[0.8s] flex justify-center items-center bg-[#cb23525c]">
