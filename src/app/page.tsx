...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between border- bg-black overflow-hidden border-box">
      {/* header */}
      <div
        className="w-full  flex-row gap-5 h-[max-content] flex "
        data-aos="fade-in"
        data-aos-duration="800"
        data-aos-easing="ease-in-out"
        data-aos-mirror="true"
        style={{
          backgroundImage: `url(${helo.src})`,
      ...
      >
        <div className="flex flex-col md:flex-row md:justify-evenly">
          <div
            className="w-[1px] bg-white/50 ms-[30px]"
            data-aos="slide-down"
            data-aos-delay="50"
            data-aos-duration="800"
            data-aos-easing="ease-in-out"
            data-aos-mirror="true"
          ></div>
          <div className=" p-4 px-16 md:ps-20  w-full md:w-[45%]">
            <div className="md:mt-[30%]">
              <h1
                className="text-white text-[32px] text-start font-bold"
                data-aos="fade-right"
                data-aos-delay="20"
                data-aos-duration="800"
                data-aos-easing="ease-in-out"
              ...
              <h2
                className="text-black text-[72px] w-[40rem] mt-[-20px] font-bold"
                data-aos="fade-up"
                data-aos-delay="100"
                ...
                data-aos-mirror="true"
              >
                {user == null ? "User" : user?.displayName}
              </h2>
              <div
          ...
          <div>
            ...
            <Image
              src={headerimg}
              className="object-center drop-shadow-md hover:drop-shadow-xl 	"
              alt=""
              loading="lazy"
            />
          </div>
      ...
      <div className="p-5 mt-5">
        <div
          className="h-[1px] w-[90%] bg-white/50"
          data-aos="slide-left"
          data-aos-delay="100"
          data-aos-duration="800"
          data-aos-easing="ease-in-out"
        ...
        ></div>
        <h2
          className="font-bold text-white text-[72px]"
          data-aos="fade-up"
          data-aos-delay="100"
          data-aos-duration="800"
          data-aos-easing="ease-in-out"
        ...
        <div className="flex gap-10 justify-evenly">
          ...
          <Card
            img={event1}
            EventHeading="The Final Showdown: Thanos Returns"
            desc="In the Avengers' last stand, Thanos returns with the Infinity Gauntlet, prompting a perilous mission to reverse the Snap's devastation and save the universe."
          />
          <Card
            img={event2}
            EventHeading="Ultron Unleashed: The AI Apocalypse"
            desc="The Avengers face their greatest threat as Ultron, an AI gone rogue, launches a relentless assault to annihilate humanity."
          />

          <Card
            img={event3}
            EventHeading="Rise of Doc Ock: The Octopus Strikes"
            desc="Doctor Octavius unleashes chaos with his mechanical tentacles, and the Avengers race to stop his sinister plans."
          />
        </div>
      </div>
      ...
      <div className="p-5 mt-5 text-white">
        <div className="grid grid-cols-5 gap-3">
          <div className="col-span-2 border-[.5px] border-white/50 p-5 ">
            <h3
              className="font-bold text-white text-[64px] border-t-[.4px] border-white/65"
              data-aos="fade-right"
              data-aos-delay="80"
              data-aos-duration="800"
              data-aos-easing="ease-in-out"
            ...
            >
              We're{" "}
              <span className="text-red-500 [text-shadow:_0_6px_0_rgb(255_255_255_/_40%)]">
                AVENGERS
              </span>{" "}
            </h3>
            <br />
            <div className="my-auto">
              ...
              >
                ...
                <p className="text-justify pe-5">
                  Thanos will surely prevail, with his relentless quest to
                  gather the Infinity Stones. Each Avenger, from Iron Man to
                  Captain America, must rise to the challenge, rallying their
                  strength and resolve to thwart his destructive ambitions.
                  Together, they face perilous battles and personal sacrifices,
                  driven by a shared mission to safeguard the very essence of
                  humanity."
                </p>
              </div>
          ...
          <div
            className="col-span-3 border-[.5px] border-white"
            data-aos="slide-right"
            data-aos-delay="40"
          ...
          <div className="col-span-2 p-5 border-l-[.5px] border-white/65">
            ...
            >
              <p className="text-white font-medium uppercase mt-8 text-[24px]">
                Choose your own team and test your skills
              </p>
              <br />
              <p className="text-white text-justify pe-4">
                ...
                overwhelming odds. With their unwavering commitment to justice
                and the greater good, the Avengers stand as a beacon of hope for
          ...
          <div className="col-span-3 p-4 text-start">
            <div className="flex gap-2 justify-evenly">
              ...
              <div className="text-red-500">
                <h2
                  className="text-[72px] font-bold text-black"
                  data-aos="slide-right"
                  data-aos-delay="40"
                  data-aos-duration="1000"
                  data-aos-easing="ease-in-out"
                ...
                <br />
                <p
                  className="font-medium pe-10"
                  data-aos="fade-up"
                  data-aos-easing="linear"
                  data-aos-duration="1400"
                >
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Voluptatem earum officiis inventore cupiditate repudiandae,
                  possimus natus ipsa ab. Quos quam odit totam maiores unde
                  provident doloremque in velit inventore quisquam.
                </p>
                <br />
                <Link href="/gallery">
                  <button
